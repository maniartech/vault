...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      { pattern: './index.mini.js', type: 'module' },
      { pattern: './index.mini.d.ts', included: false },
      { pattern: './encrypted-vault.js', type: 'module' },
      { pattern: './encrypted-vault.d.ts', included: false },
